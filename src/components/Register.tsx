      ...
      >
        {({values, isSubmitting , isValid, validateForm,setFieldValue, setValues}) => (
          <Form className='bg-gray-400 w-[65%] mx-auto rounded-xl py-3 my-3'>
            ...
            {
              values.user_type === 'Job_Seeker'  && (<InputField fieldName='lastName'  label='Last Name' placeHolder='Enter your Last Name' />
              )
            }
            ...
            <InputField fieldName='phoneNo'  label='Phone Number' placeHolder='Enter Your Phone No' />
